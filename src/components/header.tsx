...
export function Header() {
  ...
  return (
      ...
      <div className=" mx-auto flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        {/* <div className="flex-1 max-w-2xl mx-8">
          <div className="relative">
            ...
            <Button
              size="sm"
              className="absolute right-0 top-0 h-full px-4 rounded-r-full bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700"
            >
    ...
    // <header className="fixed top-0 left-0 right-0 h-16 bg-background z-50 flex items-center px-4 border-b w -full">
    //   <div className="flex items-center gap-4 size-3 md:size-4">
    //     <Link to="/" className="flex items-center gap-1">
    //       <svg viewBox="0 0 90 20" className=" h-4">
    //         <g viewBox="0 0 90 20">
    //           <path
